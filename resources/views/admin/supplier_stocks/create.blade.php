...
@section('content')
    ...
    <div class="admin-card">
        ...
        <form action="/admin/supplier-stocks/store" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" name="item_name" class="form-control" placeholder="Contoh: Keripik Singkong"
                    value="{{ request('item_name') }}" required>
            </div>

            <div
                style="background: #f8f9fa; padding: 20px; border-radius: 8px; border: 1px solid #ddd; margin-bottom: 20px;">
                <h3
                    style="margin-top: 0; color: #2e7d32; display: flex; justify-content: space-between; align-items: center;">
                    <span>Varian Ukuran & Harga</span>
                    <button type="button" class="btn btn-success btn-sm" onclick="addVariantRow()"
                        style="padding: 5px 12px; font-size: 13px; font-weight: 600;">+ Tambah Varian</button>
                </h3>
                ...
                <div id="variants-container">
                    <div class="variant-row" style="display: flex; gap: 10px; margin-bottom: 10px; align-items: flex-end;">
                        ...
                        <div style="flex: 1.5;">
                            ...
                            <input type="number" name="variants[0][initial_quantity]" class="form-control"
                                placeholder="Stok" required min="1">
                        </div>
                        <div style="flex: 2;">
                            <label style="font-size: 12px; font-weight: bold; color: #555;">Harga Beli (Modal) *</label>
                            <input type="number" name="variants[0][buy_price]" class="form-control buy-price-input"
                                placeholder="Harga Beli" required min="0" oninput="calculateSellingPrice(this)">
                        </div>
                        <div style="flex: 2;">
                            <label style="font-size: 12px; font-weight: bold; color: #166534;">Harga Jual (+30% Otomatis)
                                *</label>
                            <input type="number" name="variants[0][price]" class="form-control sell-price-input"
                                placeholder="Harga Jual" required min="0">
                        </div>
                        <div style="flex: 2;">
                            <label style="font-size: 12px; font-weight: bold; color: #555;">Tgl Masuk *</label>
                            <input type="date" name="variants[0][entry_date]" class="form-control"
                                value="{{ date('Y-m-d') }}" required>
                        </div>
                        <div style="flex: 2;">
                            <label style="font-size: 12px; font-weight: bold; color: #555;">Tgl Expire (Opsional)</label>
                            <input type="date" name="variants[0][expiry_date]" class="form-control">
                        </div>
                        <div style="flex: 0.5;">
                            <button type="button" class="btn btn-danger" onclick="removeVariantRow(this)"
                                style="width: 100%; display: none;">&times;</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-control" rows="3" placeholder="Masukkan deskripsi produk..."
                    required></textarea>
            </div>
            ...
            <div class="form-group">
                <label
                    style="display: flex; align-items: center; gap: 8px; cursor: pointer; margin-top: 15px; margin-bottom: 15px;">
